...
`conda install geoplot -c conda-forge`
    ...
    *Installing Geoplot can take over 20 minutes

`conda install --channel conda-forge geopandas`


## Generating Identical Data and Plots ##
To generate identical data and plot, use `get_data` to get data from Congresses 117. 
